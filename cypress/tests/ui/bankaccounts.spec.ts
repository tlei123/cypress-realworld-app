...
describe("Bank Accounts", function () {
  ...
  it("creates a new bank account - C25181", function () {
  ...
  it("should display bank account form errors - C25182", function () {
  ...
  it("soft deletes a bank account - C25183", function () {
    cy.visit("/bankaccounts");
  ...
  it("renders an empty bank account list state with onboarding modal - C25184", function () {
    cy.wait("@getNotifications");
    cy.intercept("POST", apiGraphQL, (req) => {
      const { body } = req;
      if (body.hasOwnProperty("operationName") && body.operationName === "ListBankAccount") {
